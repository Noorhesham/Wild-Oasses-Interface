    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            Our {numberOfCabins} luxury cabins provide a cozy base, but the real freedom and peace you&apos;ll find in
      ...
      <div className="col-span-2">
        <Image src={image1} alt="Family sitting around a fire pit in front of cabin" />
      </div>
